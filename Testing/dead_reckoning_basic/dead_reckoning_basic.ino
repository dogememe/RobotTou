...
// TIME INTERVALS
#define POSITION_COMPUTE_INTERVAL 100 // milliseconds
...
void attachInterrupts() {
	attachInterrupt(digitalPinToInterrupt(2), leftTicks++, CHANGE);
	attachInterrupt(digitalPinToInterrupt(3), rightTicks++, CHANGE);
}
